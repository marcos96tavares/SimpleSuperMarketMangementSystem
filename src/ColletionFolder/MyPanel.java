package ColletionFolder;//Home Page http://guigenie.cjb.net - Check often for new versions!

import javax.swing.*;
import java.awt.*;

/**
 * MyPanel is a custom JPanel that provides a graphical user interface (GUI) component.
 * This class extends the standard JPanel class and can be used to create a specific
 * panel with customized features for a user interface.
 */
...
public class MyPanel extends JPanel {
    ...
    private JList<Product> listDisProduct;

    private JList<Activity> listDisplayitem;
    private JComboBox comboxAtivity;
    ...
    public MyPanel() {
        ...
        activiityQuaLabel = new JLabel ("Activity quantity");
        ...
        DelecteProButton = new JButton ("Delete Pro");
        ...
        serves = new Serves();
        listDisplayitem = new JList<>(new Activity[0]);
        listDisProduct = new JList<>(new Product[0]);
        String[] CombAticity = {"","AddToStock","RemoveFromStock"};
        comboxAtivity = new JComboBox (CombAticity);
       ...
       // DisplayAreaBox.setBounds (565, 60, 800, 300);
        listDisplayitem.setBounds(565, 60, 800, 300);
        comboxAtivity.setBounds (395, 170, 100, 25);
        listDisProduct.setBounds(565, 60, 800, 300);
        ...
        DisplayListProButton.addActionListener(e -> {
            ...
            listDisProduct.setListData(serves.displayListProductsDetails());
        ...
        DisplayByCategory.addActionListener(e -> {
            ...
            listDisProduct.setListData(serves.displayByCategorySortByQuantity(productCategory));
        });
 ...
 */
    ...
    private String activityName() {
        ...
        try {
            ...
            activityName = String.valueOf(comboxAtivity.getSelectedItem()); // Make sure activityNameText is properly initialized
